...
class adLDAP {
    ...
    * @var string
    */   
	protected $accountSuffix = "@newcastle.local.ad";
    ...
    * @var string
    */
	protected $baseDn = "DC=newcastle,DC=local,DC=ad"; 
    ...
    * @var array
    */
    protected $domainControllers = array("4430ndc01.newcastle.local.ad, 4430ndc02.newcastle.local.ad");
